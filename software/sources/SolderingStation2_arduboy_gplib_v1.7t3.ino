...
const unsigned char *Ico_table[] = {
  Set0, Set1, Set2, Set3, Set4, Set5, Set6, Set_LANG, QRC, Set7,
...
const byte Menu_table[] = {10, 6, 4, 4, 2, 2, 2, 2, 3, 2, 3}; //菜单 标签 温控 定时 控制方式 首页 蜂鸣器 标签删除确认界面 语言菜单 翻转 显示
...
const char *const EN_table[] PROGMEM = {EN_0, EN_1, EN_2, EN_3, EN_4, EN_5, EN_6, EN_7, EN_38, EN_8, EN_9, EN_10, EN_11, EN_12, EN_13, EN_14, EN_15, EN_16, EN_17, EN_18, EN_19, EN_20, EN_21, EN_22, EN_23, EN_24, EN_25, EN_26, EN_27, EN_28, EN_29, EN_30, EN_31, EN_32, EN_39, EN_33, EN_34, EN_35, EN_36, EN_37,};
...
const unsigned char *CN_table[] = {
  t0, t1, t2, t3, t4, t5, t7, t6, tAbout, Back, //0
...
#define MISAKI_FONT_F2_SIZE 0x1E // misaki_font_f2.h の最終行の値をここに設定する、最大0xEFまで
...
/*
  ...
  汉字转换表:温度調節低電圧言語戻取替名前変更削除追加保存睡眠閉開中国英日本
*/
...
const char *const JP_table[] = {JP_0, JP_1, JP_2, JP_3, JP_4, JP_5, JP_6, JP_7, JP_38, JP_8, JP_9, JP_10, JP_11, JP_12, JP_13, JP_14, JP_15, JP_16, JP_17, JP_18, JP_19, JP_20, JP_21, JP_22, JP_23, JP_24, JP_25, JP_26, JP_27, JP_28, JP_29, JP_30, JP_31, JP_32, JP_39, JP_33, JP_34, JP_35, JP_36, JP_37,};
const char JP_Length_table[] PROGMEM = {6, 5, 5, 7, 6, 4, 9, 3 ,5, 4, 9, 10, 8, 3, 3, 3, 6, 3, 5, 3, 3, 5, 5, 3, 6, 4, 4, 5, 5, 4, 5, 4, 4, 3, 4, 5, 4, 9, 5, 3,};
...
uint8_t MenuScreen(uint8_t selected) {
  ...
  do {
    ...
    if (LANG == 0) arduboy.drawSlowXYBitmap(48, 48, CN_table[selected + QueryMenuObject()], 36, 16, 1); else if (LANG == 2) {
      drawText(48, 52, JP_table[selected + QueryMenuObject()], pgm_read_byte(&(JP_Length_table[selected + QueryMenuObject()])));
    } else {
